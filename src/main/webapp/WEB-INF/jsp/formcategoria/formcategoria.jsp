...
<html lang="pt-br">
    <head>
        ...
        <title>FoxShop - Form Categoria</title>
                    ...
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input class="form-control" id="nome" name="categoria.nomeCateg" value="${categoria.getNomeCateg()}" minlength="3" maxlength="60" type="text" placeholder="Nome" required="required" data-validation-required-message="Please."/>
